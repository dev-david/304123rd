				...
				<!-- Intro -->
					<section id="top" class="one">
						<div class="container">
							...
							<header>
								<h3 class="alt">Thinking about selling <span class="blackblock"> 3041 23rd Ave?</span> Let us help! Team Fast Agents is YOUR personal team of professionals who makes Real Estate <span class="blueblock">EASY</span> for <span class="greenblock">YOU.</span></h3>
							</header>
							...
							<iframe width="420" height="315" src="//www.youtube.com/embed/vPuHVIVMaz0" frameborder="0" allowfullscreen></iframe>
					...
					<section id="about" class="three">
						<div class="container">
							<header>
								...
								<h3 style="color: #ecf0f1;">Properties sold within area of 3041 23rd Ave</h3>
							</header>
							<div class="row">
								<div class="4u">
									<article class="item">
